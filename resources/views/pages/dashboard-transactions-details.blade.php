...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        <div class="dashboard-heading">
            <h2 class="dashboard-title">#STORE0123</h2>
            <p class="dashboard-subtitle">Transaction Detailss</p>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <img src="/images/product-orange-boggota.jpg" alt="product" class="w-100 mb-3" />
                                </div>
                                <div class="col-12 col-md-8">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="product-title">Costumer Name</div>
                                            <div class="product-subtitle">Hamster Kaget Banget</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="product-title">Product Name</div>
                                            <div class="product-subtitle">Some Product Name</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="product-subtitle">$123,12</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <template v-if="status == 'shipping'">
                                            <div class="col-md-3">
                                                <div class="product-title">Inpu Resi</div>
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <button class="btn btn-success px-3 py-2">Save Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
