            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="owner">By somebrand</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        ...
                        <p>
                            Bring the past into the future with the Nike Air Max 2090, a bold look inspired by the DNA of the iconic Air Max 90. Brand-new Nike Air cushioning underfoot adds unparalleled comfort while transparent
                            mesh and vibrantly coloured details on the upper are blended with timeless OG features for an edgy, modernised look.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img src="/images/profile-2.png" alt="profile" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Kaori Cicak</h5>
                                    When I saw at first, it was really awesome to have with. Just let me know if there is another upcoming product like this.
                                </div>
                            </li>
                            <li class="media">
                                <img src="/images/profile-1.png" alt="profile" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Kaori Cicak</h5>
                                    When I saw at first, it was really awesome to have with. Just let me know if there is another upcoming product like this.
                                </div>
    ...
    var gallery = new Vue({
        ...
        data: {
            ...
            photos: [
                {
                    id: 1,
                    url: "/images/sova-1.png",
                },
                {
                    id: 2,
                    url: "/images/sova-4.png",
                },
                {
                    id: 3,
                    url: "/images/sova-3.jpg",
                },
                {
                    id: 4,
                    url: "/images/sova-4.png",
