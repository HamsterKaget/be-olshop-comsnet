...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        <div class="dashboard-heading">
            ...
            <p class="dashboard-subtitle"> Edit Existing Category !</p>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('category.update', $item->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="photo">Category Logo <span class="text-muted italic" style="font-size: 14px;">( Leave blank if you dont want to edit your category logo, Recommended Resolution is 64 x 64px )</span>  <span class="text-danger"></span></label>
