        ...
        <div class="container">
            <div class="row align-items-center row-login">
                <div class="col-lg-6 text-center">
                    <img src="./images/login_placeholder-1.png" alt="" class="mb-4 mb-lg-0" style="border-radius: 0 22px 0 22px; width: 60%" />
                </div>
                <div class="col-lg-5">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-3">
                        ...
                        <button type="submit" class="btn btn-success btn-block w-75 mt-4">Sign In to My Acount</button>
